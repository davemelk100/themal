  ...
  return (
    ...
    >
      ...
      >
        ...
        <p
          className="text-sm mb-4 ds-text-subtle"
        >
        ...
        {prError && (
          <div
            className="text-xs rounded-lg p-3 mb-4 ds-text-destructive"
        ...
        <div className="flex justify-end gap-2">
          ...
          <button
            ...
            className="ds-modal-btn h-9 px-4 text-sm rounded-lg transition-colors hover:opacity-80 disabled:opacity-50 ds-surface-primary"
          >
            {sectionPrStatus["main"]?.status === "creating"
              ? "Preparing..."
