    ...
    <div className="min-h-screen" style={{ backgroundColor: "hsl(var(--background))" }}>
      <div className="w-full max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        ...
        <div className="space-y-6">
          <section>
            <h2 className="text-[15px] font-medium uppercase tracking-wider mb-2" style={{ color: "hsl(var(--muted-foreground))" }}>
              Overview
            </h2>
          ...
          <section>
            ...
            <ol className="text-[17px] leading-relaxed list-decimal pl-5 space-y-3" style={{ color: "hsl(var(--foreground))" }}>
              <li>
            ...
            <p className="text-[17px] leading-relaxed mt-3" style={{ color: "hsl(var(--foreground))" }}>
